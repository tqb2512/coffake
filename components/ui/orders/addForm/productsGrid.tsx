...
export default function ProductsGrid({
    ...
    const [productOrder, setProductOrder] = React.useState<Order>({
        id: order.id,
        date: new Date(),
        status: order.status,
    ...
    return (
        <div className="flex flex-row flex-1">
            <div className="flex flex-col w-3/5 mt-4 mx-8 bg-heavy-background p-4">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 mt-4">
                    {products.map((product) => (
                        <ProductCard
                            ...
                            order={order}
                            setOrder={setOrder}
                            handleOnModalPress={handleAddToOrder}
                        />
                    ))}
                </div>
            </div>
            ...
            <div className="flex flex-col w-2/5 mt-4 ms-2 me-8 bg-white p-4 h-fit">
                            ...
                            <TableRow key="1">
                                ...
                                <TableCell>
                                    <div className="flex">
                                        ...
                                        <button
                                            type="button"
                                            className="absolute top-0 -right-5 my-3"
                                        >
                                            <IoTrash />
                                        </button>
                                    </div>
                ...
                {/* Chỗ tính tổng và nút vào trang checkout*/}
